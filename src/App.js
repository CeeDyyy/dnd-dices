...
export const App = () => (
  <Canvas shadows gl={{ antialias: false }} camera={{ position: [-30, 35, -15], near: 30, far: 55, fov: 12 }}>
    ...
    <Environment resolution={32}>
      ...
      <Lightformer position={[0, 10, 10]} scale={10} color="red" intensity={6} />
      <Lightformer position={[-10, -10, -10]} scale={10} intensity={4} />
    </Environment>
    {/* Moon physics */}
    <Physics gravity={[0, -4, 0]}>
      <Scene position={[4, 0, -1.5]} scale={4}/>
      {/* <Hats /> */}
      <Dice />
...
function Hats({ count = 10, rand = MathUtils.randFloatSpread }) {
  ...
  return (
    <InstancedRigidBodies positions={positions} rotations={rotations} colliders="hull">
      <instancedMesh receiveShadow castShadow args={[undefined, undefined, count]} dispose={null}>
        ...
        <Addition useGroups>
          <Brush a geometry={nodes.Plane006.geometry} material={materials.Material} />
          <Brush b geometry={nodes.Plane006_1.geometry} material={materials.boxCap} />
        </Addition>
      </instancedMesh>
...
function Dice({ count = 1, rand = MathUtils.randFloatSpread }) {
  ...
  return (
    <InstancedRigidBodies positions={positions} rotations={rotations} colliders="hull">
      <instancedMesh receiveShadow castShadow args={[undefined, undefined, count]} dispose={null}>
        {/* Merging the hat into one clump bc instances need a single geometry to function */}
        <Addition useGroups>
          <Brush a geometry={nodes.Solid002_Material001_0.geometry}
            // material={materials['Material.001']}
          />
          <Brush b geometry={nodes.Solid002_letters_0.geometry} material={materials.letters} />
        </Addition>
      </instancedMesh>
    </InstancedRigidBodies>
  )
